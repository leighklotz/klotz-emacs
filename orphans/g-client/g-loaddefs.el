...
Prompt user for event params and return an event structure." t nil)

(autoload (quote gcal-add-event) "gcal" "\
Add a calendar event." t nil)

(autoload (quote gcal-delete-event) "gcal" "\
Delete a calendar event." t nil)

(autoload (quote gcal-show-calendar) "gcal" "\
Show calendar for currently authenticated user." t nil)

(autoload (quote gcal-show-event) "gcal" "\
Show event at URL." t nil)

(define-prefix-command (quote gcal-calendar-prefix-map))

(autoload (quote gcal-emacs-calendar-setup) "gcal" "\
Setup GCal keybindings in Emacs calendar." nil nil)
...
Retrieve and display feed of feeds after authenticating." t nil)

(autoload (quote gblogger-atom-display) "gblogger" "\
Retrieve and display specified feed after authenticating." t nil)
